...
My jako współtwórcy i opiekunowie zobowiązujemy się, że udział w tym projekcie będzie doświadczeniem wolnym od nękania dla wszystkich, niezależnie od wieku, wyglądu, niepełnosprawności, pochodzenia etnicznego, tożsamości płciowej, poziomu doświadczenia, narodowości, religii czy orientacji seksualnej.

## Nasze standardy

Przykłady zachowań sprzyjających pozytywnemu środowisku:
...
- Używanie seksualizowanego języka lub obrazów oraz niechciane zaloty
- Trollowanie, obraźliwe komentarze i ataki osobiste lub polityczne
- Nękanie publiczne lub prywatne
- Publikowanie prywatnych informacji innych osób bez wyraźnej zgody
- Inne zachowania, które można uznać za nieodpowiednie w środowisku zawodowym
